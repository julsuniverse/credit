...
class VkAuth
{
    ...
    {
        $this->client_id='6259636'; // ID приложения
        $this->client_secret = '0KyFCXeaJYkUyy9BBR6m'; // Защищённый ключ
        $this->redirect_uri = Url::home(true).'company/auth?ufrom='.self::NETWORK_NAME.'_'.$alias; // Адрес сайта
    }
